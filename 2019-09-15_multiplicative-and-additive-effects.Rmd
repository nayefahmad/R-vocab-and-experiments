...
Note that the distribution in symmetric. That's not the case when effects are multiplicative: 
...
The shape of the curve is much clearer here. Now let's try one more thing: is the distribution of the $log(product)$ approximately normal? 
