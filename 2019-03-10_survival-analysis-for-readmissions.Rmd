...
## Data
You have data on 15 patients. Seven of them were discharged, but not observed to have been readmitted yet. Thus, we don't really have the value of the variable `days before readmit` for these patients. In the stats lingo, these are *right-censored* data.   
...
df1.readmits <- 
    data.frame(stringsAsFactors=FALSE,
                patient_id = c(1L, 2L, 3L, 4L, 5L, 6L, 7L, 8L, 9L, 10L, 11L, 12L,
                               13L, 14L, 15L),
       days.before.readmit = c(1L, 2L, 2L, 2L, 3L, 3L, 4L, 7L, 2L, 12L, 15L, 30L,
                               2L, 22L, 4L),
...
## Visualization Option 2: Survival curve^[Reference: https://rviews.rstudio.com/2017/09/25/survival-analysis-with-r/ ]
