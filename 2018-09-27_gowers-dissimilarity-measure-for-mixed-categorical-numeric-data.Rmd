...
Well, that's not easy to interpret. Let's try an alternative plotting method: 
...
Still not helping a lot. Well, let's take a look at the list of cars at different levels of the dendrogram: 
